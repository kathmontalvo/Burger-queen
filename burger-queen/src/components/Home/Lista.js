  ...
  return (
    <tr className='d-flex width-100 text-align border-bottom my-2'>
      <td className="d-flex col-4 text-align-left">
        <button onClick={() => remove(item._id)} className='border-none transparent'><i className="fas fa-trash-alt text-gray"></i></button>
      ...
      <td className="col-4">
        <p className='my-0 text-gray'>S/. {item.qty * item.price}</p>
      </td>
    </tr>)
